...
public class SecuenciaCollatzContador {
...
*/
	...
	public static void main(String[] args) {
		int numero;
		System.out.println("Bienvenido a la calculadora de secuencia de collatz, que imprime el numero de secuencias que se realizan hasta llegar a 1");
